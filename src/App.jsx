        ...
        >
          <div className="section-inner section-inner-prices">
            ...
            <div className="prices-grid">
              ...
              {/* ВЕЧЕРНИЙ ОБРАЗ */}
              <div className="price-card">
                <h3 className="price-title">Вечерний образ</h3>
                <p className="price-subtitle">
            ...
            <div className="courses-grid">
              <div className="course-card">
                ...
                <p className="course-subtitle">
                  Для тех, кто хочет красиво и быстро собирать себя каждый день
                </p>
                <ul className="course-list">
                  <li>Разбор вашей косметички и рекомендаций по продуктам.</li>
                  <li>Техника дневного и лёгкого вечернего макияжа.</li>
                  <li>Подбор оттенков под ваш цветотип.</li>
                </ul>
                <div className="course-price">
                  3 занятия по 2,5 часа — <b>от 18 000 ₽</b>
                </div>
                <a href="#contacts" className="btn btn-outline">
                  Записаться на курс
                </a>
        ...
        >
          <div className="section-inner section-inner-about">
            ...
            <div className="about-content">
              ...
              <p className="section-description">
                Я — визажист и стилист, специализируюсь на свадебных и вечерних
                образах, а также обучении макияжу. В работе ценю индивидуальность
                и естественную красоту, подчеркивая сильные стороны вашей внешности.
              </p>

              <ul className="about-list">
                <li>Опыт работы с невестами, выпускницами и клиентами разного возраста.</li>
                <li>Работаю только на профессиональной косметике.</li>
                <li>Продумываю образ от макияжа до причёски и аксессуаров.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        >
          <div className="section-inner section-inner-contacts">
            ...
            <div className="contacts-map">
              <iframe
                title="Карта локации"
                src="https://yandex.ru/map-widget/v1/?um=constructor%3A8c3ea86560adffe1965d86f9a3f5bd8b4a1a278e6b8980c97c7c1b3e76aa87e5&amp;source=constructor"
                width="100%"
                height="100%"
                frameBorder="0"
                loading="lazy"
